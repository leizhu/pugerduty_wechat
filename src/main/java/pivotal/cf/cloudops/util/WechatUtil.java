...
import pivotal.cf.cloudops.entity.AccessToken;
...
public class WechatUtil {
    ...
    public static AccessToken getAccessToken(String appid, String appsecret) {
        ...
        if (null != jsonObject) {
            try {
                ...
                // 获取token失败
                try {
                    logger.error("获取token失败 errcode:" + jsonObject.getInt("errcode")
    ...
    public static String getToken() {
        AccessToken at = WechatUtil.getAccessToken(ConstantWeChat.APPID, ConstantWeChat.APPSECRET);
        if (null != at) {
            return at.getToken();
        } else {
            return null;
